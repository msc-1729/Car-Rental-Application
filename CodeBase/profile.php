          ...
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" name="fullname" value="<?php echo htmlentities($result->FullName);?>" id="fullname" type="text" pattern="[A-Za-z ]+" title="enter your name"  required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" name="mobilenumber" pattern = "[0-9]+" title="enter a valid mobile number"value="<?php echo htmlentities($result->ContactNo);?>" id="phone-number" type="text" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg"  id="country" name="country" pattern="[A-Za-z]+" title="enter your country name"value="<?php echo htmlentities($result->City);?>" type="text">
            </div>
            <div class="form-group">
              <label class="control-label">City</label>
              <input class="form-control white_bg" id="city" name="city" pattern = "[A-Za-z]+" title="enter your city name" value="<?php echo htmlentities($result->City);?>" type="text">
            </div>
            <?php }} ?>
