      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>We got the right car for you.</h1>
            <p>YOU NAME IT. WE GIVE IT.ALWAYS AT YOUR SERVICE. </p>
             </div>
        </div>
      </div>
    </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>What The Cab  <span>Online Cab Rental Portal</span></h2>
      <p>AN ALWAYS TO GO COMPANY FOR A PERSON WHO IS IN NEED OF A CAR. FIND THE BEST SUITABLE CARS FOR YOU AT VERY REASONABLE RATES.</p>
    </div>
    <div class="row"> 
